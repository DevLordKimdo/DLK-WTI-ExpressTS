...
import logicPatternPrgRoute from './logic.pattern.prg.route';
import logicPatternWizardRoute from './logic.pattern.wizard.route';
...
import uixFormSearchSelectboxRoute from './uix.form.searchselectbox.route';
...
router.use('/tmpl/logic/pattern/prg', logicPatternPrgRoute);
router.use('/tmpl/logic/pattern/wizard', logicPatternWizardRoute);
...
router.use('/tmpl/uix/form/search-selectbox', uixFormSearchSelectboxRoute);
